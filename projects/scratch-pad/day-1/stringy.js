...
function length(string) {
   ...
   // use .length to return the length of the string 
...
function toLowerCase(string) {
    // YOUR CODE BELOW HERE //
// return result of lowercase string
...
function toUpperCase(string) {
    ...
    // return the string parameters that you will pass throught to uppercase 
...
console.log('this is the length of string one',stringOneLength); 
